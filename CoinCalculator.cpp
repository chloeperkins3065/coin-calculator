...
CS231 Lab2
Coin Calculator
My program will take the user input of how many of each coin the user has and calcualte it 
and tell the user how much money he has with the coins they input.
Due: January 30, 2020*/
#include <iostream>
#include <iomanip>
using namespace std;
